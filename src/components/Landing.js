...
(
  <section className="landing">
    ...
    <section className="selling-points">
      <img className="selling-points-left" src={spaceShip}></img>
      <div className="selling-points-right">
        ...
        <div className="point">
          ...
          <p className="point-description">Listen to your music on the go. This streaming service is available on all mobile plafforms.</p>
        </div>
      </div>
    </section>
